...
(function () {
  ...
  function render() {
    ...
    app.querySelectorAll('.sb-new-btn').forEach(el=>{
      ...
      el.innerHTML='<span class="ll-plus">'+icon('plus')+'</span><span class="new-consultation-label">New Consultation</span><span class="new-consultation-arrow">'+icon('arrow')+'</span>';
